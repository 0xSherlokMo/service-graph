...
type CheckInteractionsRequest struct {
	...
	MedicationId string      `protobuf:"bytes,2,opt,name=medicationId,proto3" json:"medicationId,omitempty"`
}
...
func (x *CheckInteractionsRequest) GetMedicationId() string {
	if x != nil {
...
var file_graph_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x6d, 0x65, 0x64, 0x69, 0x63, 0x61, 0x74, 0x69,
